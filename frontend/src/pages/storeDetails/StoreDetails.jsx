...
const StoreDetails = () => {
    ...
    return <main className='container store-details-container'>
                ...
                <div className='d-flex flex-column justify-content-center h-100'>
                    ...
                    <div className="row">
                        ...
                        <section className="col-lg-6 col-xs-12">
                            ...
                            <p className='store-open-status'>{showStoreOpenStatus} <GoChevronUp /></p>

                            {timings.map((timing, index) => <div className='row' key={index}>
                                <section className="col-lg-6 col-5">
                                    <p className={`default-timings ${index === today ? 'today-timings' : 'timings'}`}>{timing[0]}</p>
                                </section>
                                <section className="col-lg-6 col-4">
                                    <p className={`default-timings ${index === today ? 'today-timings' : 'timings'}`}>{timing[1]}</p>
                                </section>
                            </div>)}
