...
const Login = () => {
    ...
    return <main className='container h-100 d-flex justify-content-center align-items-center'>
        <div>
            <p className='logo-text'>Brand Logo/Name</p>
            <button className='sign-in-btn' onClick={onClick} disabled={isLoading}>
                <FcGoogle size={25} opacity={isLoading ? .55 : 1} /> {isLoading ? "Loading. Please wait!" : "Sign In With Google"}
            </button>
        </div>
    </main>;
}
